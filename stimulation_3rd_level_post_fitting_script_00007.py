...
def smooth_est(zstat):
     ...
     if zstat[-25:-21] == '05Hz':
          res4d = '/media/amr/Amr_4TB/Work/stimulation/stimulation_3rd_level_CA3/05Hz/flameo/res4d.nii.gz'
          smooth_est.inputs.dof = 7
     elif zstat[-25:-21] == '10Hz':
          res4d = '/media/amr/Amr_4TB/Work/stimulation/stimulation_3rd_level_CA3/10Hz/flameo/res4d.nii.gz'
          smooth_est.inputs.dof = 9
     elif zstat[-25:-21] == '20Hz':
          res4d = '/media/amr/Amr_4TB/Work/stimulation/stimulation_3rd_level_CA3/20Hz/flameo/res4d.nii.gz'
          smooth_est.inputs.dof = 9
     elif zstat[-25:-21] == '40Hz':
          res4d = '/media/amr/Amr_4TB/Work/stimulation/stimulation_3rd_level_CA3/40Hz/flameo/res4d.nii.gz'
          smooth_est.inputs.dof = 9
